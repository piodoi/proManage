...
from app.models import (
    TokenData, UserRole, Supplier, PropertySupplier,
    BillType
)
...
async def setup_ebloc_supplier_for_properties(
    ...
    """Automatically set up E-bloc supplier for imported properties (no credentials saved)"""
    ...
    # Add E-bloc supplier to all specified properties (without credentials)
    added_count = 0
