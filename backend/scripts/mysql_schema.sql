...
CREATE TABLE user_preferences (
    ...
    iban VARCHAR(50) NULL COMMENT 'RON IBAN for rent payments',
    iban_eur VARCHAR(50) NULL COMMENT 'EUR IBAN for rent payments',
    iban_usd VARCHAR(50) NULL COMMENT 'USD IBAN for rent payments',
